...
public class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> CONTEXT_PROFILE = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> RESPONSE_TONE = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> OLLAMA_ENDPOINT = BUILDER
            .comment("Base URL for the local Ollama server.")
            .define("ollamaEndpoint", "http://127.0.0.1:11434");

    public static final ForgeConfigSpec.ConfigValue<String> LM_STUDIO_ENDPOINT = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue INCLUDE_INVENTORY_CONTEXT = BUILDER
            .comment("Whether MCAI should include your current inventory in AI prompts.")
            .define("includeInventoryContext", true);

    public static final ForgeConfigSpec.BooleanValue INCLUDE_PLAYER_CONTEXT = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue INCLUDE_MODPACK_CONTEXT = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue INCLUDE_RECIPE_CONTEXT = BUILDER
            .comment("Whether MCAI should include matching loaded recipes in AI prompts.")
            .define("includeRecipeContext", true);

    public static final ForgeConfigSpec.BooleanValue INCLUDE_QUEST_CONTEXT = BUILDER
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_OFFLINE_FALLBACK = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> CHAT_MODE = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> SHARE_WHITELIST = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue MAX_RECIPE_CONTEXT_RESULTS = BUILDER
            .comment("Maximum number of matching recipes to include in AI prompts.")
            .defineInRange("maxRecipeContextResults", 8, 1, 25);

    public static final ForgeConfigSpec.IntValue RECIPE_BRANCH_MAX_DEPTH = BUILDER
            .comment("Maximum recipe branch depth shown in the MCAI GUI tracked-recipe visual.")
            .defineInRange("recipeBranchMaxDepth", 4, 2, 8);

    public static final ForgeConfigSpec.IntValue RECIPE_BRANCH_MAX_CHILDREN = BUILDER
    ...
    public static final ForgeConfigSpec.ConfigValue<String> OLLAMA_MODEL = BUILDER
            .comment("Model name to use for AI chat. Applies to Ollama and LM Studio.")
            .define("ollamaModel", "gemma4:latest");

    public static final ForgeConfigSpec.ConfigValue<String> SYSTEM_PROMPT = BUILDER
    ...
    public static final ForgeConfigSpec.IntValue REQUEST_TIMEOUT_SECONDS = BUILDER
